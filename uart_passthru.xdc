...
#create_clock -add -name clk_pin -period 80.33 -waveform {0 40.16} [get_ports {clk_12mhz}];
...
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { io_tx }]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { io_rx }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
...
#set_property -dict { PACKAGE_PIN L2    IOSTANDARD LVCMOS33 } [get_ports { pio[13] }]; #IO_L5N_T0_AD13N_35 Sch=pio[14]
